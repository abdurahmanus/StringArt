...
def generate_string_art(
    input_file: UploadFile = File(...), side_len: int = Form(300), 
    export_strength: float = Form(0.1), nail_step: int = Form(4), 
    wb: bool = Form(False), rgb: bool = Form(False), rect: bool = Form(False)):
